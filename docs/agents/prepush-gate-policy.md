...
lastReviewedNote: 'Reviewed Issue #614 selector proof and V8-safe single-worker recycle boundary together with the v0.0.48 checkpoint; hook ownership, 100% src coverage, and bounded managed-push recovery remain unchanged.'
---
