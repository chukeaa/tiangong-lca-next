...
lastReviewedNote: 'Reviewed Issue #614 selector proof and V8-safe single-worker Jest gate together with the v0.0.48 checkpoint; the complete inventory, 100% src coverage, Calculation Bundle, Release-read, German delta, and clean-runner requirements remain authoritative.'
related:
  - ../AGENTS.md
  - ../.docpact/config.yaml
